    ...
    return (
        <div className="space-y-6">
            <p className="text-[16px] text-[#5F5F65]">
                Agree to our privacy policy, and let us know if you'd like to receive personalized recommendations by email. Once you're ready, submit to get your tailored insights.
            </p>
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <RadioGroup
                            ...
                            className="space-y-1"
                        >
                            <FormItem key={"Email"} className="flex items-center space-x-2 space-y-0">
                                <FormControl>
                                    <RadioGroupItem value={"Email"} id={"Email"} />
                                </FormControl>
                                <FormLabel htmlFor={"Email"}>Email</FormLabel>
                            </FormItem>
                            <FormItem key={"Text"} className="flex items-center space-x-2 space-y-0">
                                <FormControl>
