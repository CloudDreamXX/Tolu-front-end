...
const frequencyOptions = ["Every day", "A few times a week", "Once a week", "Rarely", "Never"];

const commonFoodOptions = [
    "Whole grains", "Vegetables", "Fruits", "Animal proteins", "Plant-based proteins",
    "Processed snacks", "Fast food", "Dairy", "Sugary foods", "Other"
];

const dietTypeOptions = [
    "Vegetarian", "Vegan", "Pescatarian", "Paleo", "Keto / Low Carb", "Mediterranean",
    "Intermittent Fasting", "Gluten-Free", "Dairy-Free", "Low FODMAP", "Elimination / Rotation Diet", "Other"
];
    ...
    return (
        <div className="space-y-6">
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel>Who typically decides what to eat in your household each day?</FormLabel>
