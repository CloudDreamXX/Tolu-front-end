    ...
    return (
        <div className="space-y-6">
            <p className="text-sm text-gray-500">
                Provide details about your digestion, blood sugar, metabolism, and gut health.
            </p>
                        ...
                        {form.watch("bloodSugarConcern") === "Other" && (
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            <Input placeholder="e.g., Borderline insulin resistance" {...field} />
                                        </FormControl>
                                    </FormItem>
                                )}
                            />
                        ...
                        {form.watch("digestiveIssues") === "Other" && (
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            <Input placeholder="e.g., Occasional constipation and acid reflux" {...field} />
                                        </FormControl>
                                    </FormItem>
                                )}
                            />
