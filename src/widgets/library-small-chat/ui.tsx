      ...
      if (activeChatKey === "Create content") {
        ...
        if (sessionData && sessionData.length > 0) {
          for (const item of sessionData) {
            ...
            if (
              Array.isArray(item.stored_files) &&
              item.stored_files.length > 0
            ) {
              ...
              if (audioFile && audioFile.id) {
                try {
                  ...
                  } else if (audioResult && (audioResult as any).data instanceof Blob) {
            ...
            <LibraryChatInput
              ...
              textarea={
                <div
                  ...
                  style={
                    isCoach
                      ? { backgroundColor: "rgba(28, 99, 219, 0.05)" }
                      : {}
                  }
                >
                  <textarea
