...
export const mapHealthHistoryToFormDefaults = (
  ...
  return {
    ...
    familyHistory: healthHistory?.family_health_history,
    healthConcerns: healthHistory?.current_health_concerns,
    medicalConditions: healthHistory?.diagnosed_conditions,
    exerciseHabits: healthHistory?.exercise_habits,
    stressLevels: healthHistory?.stress_levels,
