  ...
  return (
    <div className="pt-[16px] border-t border-[#DBDEE1] mt-[16px] space-y-[12px]">
      <div className={lineClass}>
        ...
        <input
          {...register("job")}
          placeholder="job type/hours"
          className={`${inputClass} w-[142px]`}
        />
        ...
        <input
          ...
          placeholder="main symptoms – e.g., trouble sleeping, mood swings, weight gain"
          className={`${inputClass} w-[568px]`}
        />
      </div>
      ...
      <div className={lineClass}>
        ...
        <input
          ...
          placeholder="other challenges – e.g., cravings, low energy, memory problems"
          className={`${inputClass} w-[544px]`}
        />
        <span>, and it feels like no matter</span>
        <input
          {...register("strategiesTried")}
          placeholder="strategies – e.g., dieting, exercising, meditating"
