          ...
          {isMobile && (
            <div className="flex items-center gap-[16px] w-full md:w-fit">
              ...
              <button
                ...
                className={`flex w-full md:w-[250px] md:h-[44px] p-[16px] md:py-[4px] md:px-[32px] justify-center items-center gap-[8px] rounded-full text-[16px] font-[Nunito] font-semibold ${isFormValid
