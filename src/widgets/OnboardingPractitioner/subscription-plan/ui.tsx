      ...
      <main className="flex flex-col items-center flex-1 justify-center gap-[32px] self-stretch px-[16px] md:p-0">
        ...
        <div className="flex items-center gap-[16px] pb-8 md:pb-[100px] w-full md:w-fit">
          ...
          <Link
            ...
            className={
              activeCard !== ""
                ? "bg-[#1C63DB] flex w-full md:w-[250px] md:h-[44px] p-[16px] md:py-[4px] md:px-[32px] justify-center items-center gap-[8px] rounded-full text-[16px]  font-semibold text-white"
                : "flex w-full md:w-[250px] md:h-[44px] p-[16px] md:py-[4px] md:px-[32px] justify-center items-center gap-[8px] rounded-full bg-[#D5DAE2] text-[16px]  font-semibold text-[#5F5F65]"
            }
          >
            Next
          </Link>
