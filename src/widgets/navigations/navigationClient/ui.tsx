...
export const NavigationClient: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Mobile Hamburger */}
      <div
        className={`flex xl:hidden justify-between items-center p-[16px] md:p-6 ${location.pathname.startsWith(`${basePath}/library`) && location.pathname.split("/").length > 2 ? "bg-white md:bg-transparent fixed top-0 w-full md:static z-[55]" : ""}`}
      >
