...
export const HealthHistorySummary = ({
    ...
    return (<div className="space-y-6">
        ...
        <Section title="Birth & Body" onEdit={() => onEditSection(1)}>
            <SummaryRow label="Breastfed or bottle" value={data?.breastfed_or_bottle} />
            <SummaryRow
        ...
        <Section title="Medical History" onEdit={() => onEditSection(5)}>
            ...
            <SummaryRow
                ...
                value={data?.cardiovascular_dates}
            />
        ...
        <Section title="Oral Health" onEdit={() => onEditSection(6)}>
            ...
            />
            <SummaryRow
                label="Dental regimen"
                value={data?.oral_dental_regimen}
            />
            <SummaryRow
        ...
        <Section title="Lifestyle History" onEdit={() => onEditSection(7)}>
            ...
            <SummaryRow
                label="Substance use"
                value={data?.substance_use_history}
            />
            <SummaryRow
        ...
        <Section title="Women’s Health" onEdit={() => onEditSection(9)}>
            <SummaryRow
                label="Age first period"
                value={data?.age_first_period}
            />
            <SummaryRow
                label="PMS / pain"
                value={data?.menses_pms_pain}
            />
            <SummaryRow
                label="Birth control"
                value={data?.birth_control_pills}
            />
            <SummaryRow
        ...
        <Section title="Goals & Support" onEdit={() => onEditSection(12)}>
            ...
            />
            <SummaryRow
                label="Why achieve goals"
                value={data?.why_achieve_goals}
            />
            <SummaryRow
