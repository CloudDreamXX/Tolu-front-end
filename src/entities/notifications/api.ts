...
export class NotificationsService {
    static async getNotifications(page: number = 1, limit: number = 20, unread_only: boolean = false, type_filter: string | null = null): Promise<any> {
        const params = {
            page,
            limit,
            unread_only,
        ...
        return ApiService.get<any>(API_ROUTES.NOTIFICATIONS.GET_NOTIFICATIONS, { params });
    }
    ...
    static async dismissNotifications(
    ...
    static async getNotificationPreferences(): Promise<any> {
        return ApiService.get<any>(API_ROUTES.NOTIFICATIONS.GET_NOTIFICATION_PREFERENCES);
    }

    static async updateNotificationPreferences(data: NotificationPreferences): Promise<any> {
        return ApiService.put<any>(API_ROUTES.NOTIFICATIONS.UPDATE_NOTIFICATION_PREFERENCES, data);
    }
}