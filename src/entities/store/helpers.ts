...
export const mapOnboardClientToFormState = (
  ...
  const lifestyle = profile.health_lifestyle ?? {};
  ...
  return {
    ...
    symptoms_severity: toRecord(goals_values.symptoms_severity),
  };
};
