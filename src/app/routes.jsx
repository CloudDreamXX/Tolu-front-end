...
const CoachesDashboard = lazy(() => import("../pages/coaches/pages/CoachesDashboard/CoachesDashboard"));
const CoachesLibraryTopicDetails = lazy(() => import("../pages/coaches/pages/coachesLibraryTopicDetails/CoachesLibraryTopicDetails"));
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "coaches-library-topic-details", element: <CoachesLibraryTopicDetails /> },
    ],
  },
  {
