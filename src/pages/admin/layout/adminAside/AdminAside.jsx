...
const AdminAside = () => {
  ...
  const projects = [
    { name: 'Project A', folders: ['Perimenopause and menopa... 1', 'Perimenopause and menopa... 2', 'Perimenopause and menopa... 3', 'Perimenopause and menopa... 4', 'Perimenopause and menopa... 5', 'Perimenopause and menopa... 6', 'Perimenopause and menopa... 7', 'Perimenopause and menopa... 8', 'Perimenopause and menopa... 9', 'Perimenopause and menopa... 10'] },
        ...
        >
          <div className="p-4 w-full">
            ...
            <div className="project-container">
              <div className="project-name flex mb-4 justify-between items-center" onClick={handleDropdownToggle}>
                ...
                <>
                  <div className="dropdown-content">
                    {projects.map((project, index) => (
                      <div key={index} className="project-item text-[#393838]">
                        <div className="text-[#393838] folders">
                          {project.folders.slice(0, showMore[project.name] ? project.folders.length : 5).map((folder, folderIndex) => (
                            <div key={folderIndex} className="folder-item">
                              ...
                              >
                                <div className="flex gap-2">
                                  ...
                                  <span className="text-[#393838] truncate w-[150px]">{folder}</span>
                                </div>
                                <span className="plus-icon"><AiOutlinePlus onClick={addArticlesHandler} /></span>
                              </div>
                              {selectedFolder === folder && (
                                <div className="folder-content  ml-4 ">
