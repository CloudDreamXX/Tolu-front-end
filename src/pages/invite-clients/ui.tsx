  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col items-center justify-center w-full gap-[40px] mt-[40px]">
        <h1 className="text-[32px] text-black font-[Inter] font-semibold text-center">Invite Clients</h1>
        ...
        <div className="bg-white rounded-[16px] py-[32px] px-[40px] w-[600px] flex flex-col gap-[24px] items-center shadow-md">
          <p className="text-left font-[Nunito] text-black text-base font-medium">Import CSV or PDF</p>
          ...
          >
            <div className="text-[#1C63DB] font-[Nunito] text-[14px] font-semibold">Click to upload</div>
            <p className="text-[#5F5F65] font-[Nunito] text-[14px] mt-[4px]">or drag and drop</p>
            <p className="text-[#5F5F65] font-[Nunito] text-[14px]">CSV or PDF file</p>
            {uploadedFileName && (
              <p className="text-[#1C63DB] font-[Nunito] text-[14px] mt-2">Uploaded: {uploadedFileName}</p>
            )}
          </div>
          <input
            ref={fileInputRef}
