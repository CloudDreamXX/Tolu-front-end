    ...
    >
      ...
      <main className="flex flex-col items-center justify-center w-full gap-[40px] mt-[40px]">
        ...
        <div className="flex items-center gap-[16px] bg-transparent">
          ...
          <button onClick={() => nav('/onboarding-finish')} className="bg-[#1C63DB] flex w-[250px] h-[44px] py-[4px] px-[32px] justify-center items-center gap-[8px] rounded-full text-[16px] font-[Nunito] font-semibold text-white">
            Next
          </button>
        </div>
      </main>
