...
export const Library = () => {
  ...
  const handleFinishCheckIn = async (results: MenopauseSubmissionRequest) => {
    await UserService.submitMenopauseResults(results, token);
    const data = await UserService.getMenopauseRecommendations(token);
          ...
          <div className="flex flex-col items-center gap-6 md:flex-row">
            ...
            <div className="flex flex-col items-start flex-grow gap-2">
              ...
              <p className="text-[16px] leading-[22px] font-normal text-[#5F5F65]">
                Check your symptoms and get personalized insights in minutes
                with our Menopause Symptom Checker.
              </p>
            </div>
            <button
                  ...
                  {!isMobile && (
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-[16px] leading-[22px] font-normal text-[#5F5F65]">
                          Based on your symptoms, we’ve selected content that’s
