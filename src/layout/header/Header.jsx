...
const Header = () => {
  ...
  const getClassNames = (index) => {
    return index === activeIndex
      ? 'flex items-center text-base font-normal rounded-lg border-2 border-[#25252526] shadow-md shadow-[#00000026] gap-3 p-2' // Active styles (border and shadow)
      : 'flex items-center text-base font-normal gap-3 p-2'; // Default styles
  };
